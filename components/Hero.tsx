  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const scrollProgress = Math.max(
        0,
        Math.min(1, (windowHeight - cardTop + rect.height / 2) / windowHeight)
      );
    };
          ...
          <div className="relative p-12 md:p-16">
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div style={{ transform: "translateZ(50px)" }}>
                ...
                >
                  Zoy delivers high-performance web solutions and AI-powered
                  automation. We create custom websites, intelligent chatbots,
                  and automated workflows that help modern businesses scale
                  efficiently.
                </motion.p>
    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        <motion.div
          ...
          className="inline-block px-4 py-1.5 mb-8 mt-10 rounded-full border border-indigo-500/20 bg-indigo-500/5 text-[10px] font-black uppercase tracking-[0.2em] text-indigo-400"
        >
        ...
        >
          Zoy builds high-performance AI chatbots, bespoke web solutions, and
          automated operations for modern businesses.
        </motion.p>
        ...
        >
          <a
            href="#consultant"
            className="px-10 py-5 bg-white text-slate-950 font-black rounded-2xl hover:scale-105 transition-all shadow-xl shadow-white/5"
          >
            Test Automation AI
          </a>
          <a
            href="#portfolio"
            className="px-10 py-5 border border-white/10 bg-white/5 backdrop-blur-md text-white font-black rounded-2xl hover:bg-white/10 transition-all"
          >
            Browse Portoflio
          </a>
        </motion.div>
